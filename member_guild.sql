...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Okt 2023 pada 12.58
...
INSERT INTO `member_baru` (`id_registrasi`, `username`, `level`, `role`) VALUES
(4, 'nazim beluga', 699, 'Flanker');
...
--
ALTER TABLE `member_baru`
  MODIFY `id_registrasi` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
